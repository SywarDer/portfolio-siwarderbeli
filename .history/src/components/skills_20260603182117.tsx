...
const skillsData = [
{ name: "Front-end Development", icon: <FaReact />, subSkills: [{ name: "HTML", icon: <FaHtml5 /> }, { name: "CSS", icon: <FaCss3Alt /> }, { name: "JavaScript", icon: <FaJs /> }, { name: "Tailwind", icon: <SiTailwindcss /> }, { name: "Alpine JS", icon: <SiAlpinedotjs /> }, { name: "MUI", icon: <SiMui /> }, { name: "Ant Design", icon: <SiAntdesign /> }, { name: "React JS", icon: <FaReact /> }, { name: "Ionic React", icon: <SiIonic /> },], }, 
{ name: "Back-end Development", icon: <FaNodeJs />, subSkills: [{ name: "FastAPI", icon: <SiFastapi /> }, { name: "Node JS", icon: <FaNodeJs /> }, { name: "Express JS", icon: <SiExpress /> }, { name: "Spring Boot", icon: <SiSpringboot /> }, { name: "ABAP RESTful", icon: <SiSap /> },], }, { name: "Databases", icon: <FaDatabase />, subSkills: [{ name: "MongoDB", icon: <SiMongodb /> }, { name: "Postgres", icon: <SiPostgresql /> }, { name: "MySQL", icon: <SiMysql /> }, { name: "InfluxDB", icon: <SiInfluxdb /> },], }, { name: "Design", icon: <FaFigma />, subSkills: [{ name: "Figma", icon: <FaFigma /> }, { name: "Adobe Illustrator", icon: <SiAdobeillustrator /> },], }, { name: "ML/DS", icon: <FaTools />, subSkills: [{ name: "Pandas", icon: <SiPandas /> }, { name: "NumPy", icon: <SiNumpy /> }, { name: "Scikit-learn", icon: <SiScikitlearn /> }, { name: "TensorFlow", icon: <SiTensorflow /> },], }, { name: "Devops & Tools", icon: <FaGitAlt />, subSkills: [{ name: "Git", icon: <FaGitAlt /> }, { name: "GitHub", icon: <FaGitAlt /> }, { name: "Docker", icon: <FaDocker /> }, { name: "CI/CD (GitHub Actions)", icon: <SiGithubactions /> }], }, { name: "Cloud/AI", icon: <FaCloud />, subSkills: [{ name: "Azure AI & ML", icon: <FaMicrosoft /> }, { name: "Cognitive Services", icon: <FaMicrosoft /> },], }, { name: "Streaming", icon: <FaStream />, subSkills: [{ name: "MQTT", icon: <FaStream /> }, { name: "Kafka", icon: <FaStream /> }, { name: "Telegraf", icon: <FaStream /> },], }, { name: "AI Workflow Automation", icon: <SiApacheairflow />, subSkills: [{ name: "Apache Airflow", icon: <SiApacheairflow /> },], },];
