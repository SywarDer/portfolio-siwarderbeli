...
import webgearLogo from "../assets/logos/image.png";
import erasmusLogo from "../assets/logos/erasmus.png";
...
import imgw3 from "../assets/projects/webgear/img3.png";

// Erasmus
import imge1 from "../assets/projects/erasmus/1780320786059.jfif";
import imge2 from "../assets/projects/erasmus/1780320787314.jfif";
import imge3 from "../assets/projects/erasmus/1780320788629.jfif";
import imge4 from "../assets/projects/erasmus/logo.png";
...
const experiences = [
   {
    ...
    date: "04/2026 – current | Màlaga, Spain",
    summary:
    ...
    story:
      "During my Erasmus in Málaga, I worked in a European educational environment at IES Cánovas del Castillo, where I developed an intranet system that improved the school’s internal experience. I also built international connections and grew through daily collaboration in a multicultural setting. Beyond work, I discovered the beauty of Andalusia and explored inspiring places like Málaga TechPark and Polo Digitales, which gave me a real insight into the region’s innovation ecosystem. It was a meaningful experience that combined learning, culture, and personal growth.",
    references: [
      {
        name: "Isabel Jiménez",
        role: "A secondary and vocational school teacher specialized in Computer Science and Mathematics",
        linkedin: "isabeljimenez@iescanovas.es",
      },
    ],
    images: [imge1, imge2, imge3,imge4],
  },
  {
    logo: webgearLogo,
...
<div className="border-t border-gray-700 pt-4">
  ...
  <div className="flex flex-col gap-2 mt-2">
    {exp.references.map((ref, idx) => {
      const isEmail = ref.linkedin && !ref.linkedin.startsWith("http");
      const href = isEmail ? `mailto:${ref.linkedin}` : ref.linkedin;
