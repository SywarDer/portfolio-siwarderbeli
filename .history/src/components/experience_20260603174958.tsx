...
const experiences = [
   {
    ...
    story:
      "During my Erasmus in Málaga, I worked in a European educational environment at IES Cánovas del Castillo, where I developed an intranet system that improved the school’s internal experience. I also built international connections and grew through daily collaboration in a multicultural setting.

Beyond work, I discovered the beauty of Andalusia and explored inspiring places like Málaga TechPark and Polo Digitales, which gave me a real insight into the region’s innovation ecosystem.

It was a meaningful experience that combined learning, culture, and personal growth."",
    references: [
      {
