...
function EventModal({ event, onClose }: { event: { images: string[]; title: string; description: string }; onClose: () => void }) {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-start justify-center bg-black bg-opacity-70 p-4 overflow-auto">
      <div className="relative bg-white rounded-lg shadow-2xl flex flex-col items-center w-full max-w-3xl md:max-w-4xl mt-8 md:mt-0">
        {/* Close button */}
        <button
          onClick={onClose}
